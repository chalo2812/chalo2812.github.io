export default function Home() {
  const terminalLines = [
    { prompt: 'gsola@portfolio:~$', command: 'whoami', output: 'Full Stack Senior | Linux mode: on' },
    { prompt: 'gsola@portfolio:~$', command: 'cat mindset.txt', output: 'autodidacta, curioso, shippeando sin drama' },
    { prompt: 'gsola@portfolio:~$', command: 'systemctl status ideas', output: 'active (running) since hace mas de 10 años' },
    { prompt: 'gsola@portfolio:~$', command: 'sudo ./deploy-ideas.sh', output: 'build passed: cafe + codigo + paciencia' },
  ]
      ...
      <div className="relative z-10 px-6 max-w-6xl mx-auto w-full grid lg:grid-cols-[0.9fr_1.1fr] gap-10 lg:gap-14 items-center animate-fade-in">
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-500 max-w-xl mx-auto lg:mx-0 mb-8 text-sm leading-relaxed">
            Técnico en Programación de Sistemas en CAECE. Desarrollador de software con años de experiencia. 
            Creo en entender el problema antes que la solución, discutir requerimientos cuando es necesario y construir 
            sistemas claros, mantenibles y bien documentados.
          </p>
